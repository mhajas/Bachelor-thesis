...
\newcommand{\resultsTable}[4]{%
 \begin{table}[h]
 	...
 	\begin{tabularx}{\textwidth}{|C||C|C|C|C|C|}
 		...
 		&
 		\vspace{0pt}
 		\begin{tabular}[b]{@{}c}\small\textbf{Bežné uzly} \\ \scriptsize(pomer úspešných) \end{tabular} &
		\vspace{0pt}
 		\begin{tabular}[b]{@{}c}\small\textbf{Tangle} \\ \scriptsize(pomer úspešných) \end{tabular} &
		\vspace{-10pt}
 		\begin{tabular}[b]{@{}c}\small\textbf{Dynamic} \\ \small\textbf{SHA} \\ \scriptsize(pomer úspešných) \end{tabular} &
		\vspace{-10pt}
 		\begin{tabular}[b]{@{}c}\small\textbf{Dynamic} \\ \small\textbf{SHA-2} \\ \scriptsize(pomer úspešných) \end{tabular} &
 		\vspace{0pt}
 		\begin{tabular}[b]{@{}c}\small\textbf{Decim} \\ \scriptsize(pomer úspešných) \end{tabular} \\
 		\hline\hline
 		#2
 		\hline
